...
import { Search, Filter, BookOpen, Star, Download, Globe, Users, Award, ArrowLeft, Home, Menu, X } from "lucide-react";
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-2 space-y-2">
              <Link href="/" className="block py-2 text-gray-600 hover:text-green-600 transition-colors">
                Home
              </Link>
              <Link href="/identify" className="block py-2 text-gray-600 hover:text-green-600 transition-colors">
                Identify Plants
              </Link>
              <Link href="/ebook-marketplace" className="block py-2 text-green-600 font-medium">
                E-book Marketplace
              </Link>
              <Link href="/pricing" className="block py-2 text-gray-600 hover:text-green-600 transition-colors">
                Pricing
              </Link>
              <Link href="/blog" className="block py-2 text-gray-600 hover:text-green-600 transition-colors">
                Blog
              </Link>
