...
import { Search, Star, Download, Globe, Award, Home, ArrowLeft, Cherry } from "lucide-react";
...
export default function HerbsAndVegetablesPage() {
  const { user } = useAuth();
  ...
  const { data: ebooks = [], isLoading: ebooksLoading } = useQuery({
    queryKey: ['/api/ebooks', searchTerm, 'herbs-and-vegetables', sortBy, priceFilter],
    queryFn: async () => {
      const params = new URLSearchParams({
        search: searchTerm,
        category: 'herbs-and-vegetables',
        sortBy,
        priceFilter,
      });
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Herbs & Vegetables</span>
            </nav>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex justify-center mb-4">
              <Cherry className="h-16 w-16" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Herbs & Vegetables</h1>
            <p className="text-xl mb-6 max-w-2xl mx-auto">
              Growing herbs and vegetables at home. Cultivate fresh, organic produce in your own garden or containers.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search herbs & vegetables e-books..."
                  value={searchTerm}
        ...
        {ebooksLoading ? (
          ...
          <>
            <div className="mb-4">
              <p className="text-gray-600">
                Found {ebooks.length} e-book{ebooks.length !== 1 ? 's' : ''} in Herbs & Vegetables
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {ebooks.map((ebook) => (
          ...
          <div className="text-center py-12">
            <div className="text-gray-400 mb-4">
              <Cherry className="h-16 w-16 mx-auto" />
            </div>
