...
import { Search, Star, Download, Globe, Award, Home, ArrowLeft, Bug } from "lucide-react";
...
export default function PestManagementPage() {
  ...
  const { data: ebooks = [], isLoading: ebooksLoading } = useQuery({
    queryKey: ['/api/ebooks', searchTerm, 'pest-management', sortBy, priceFilter],
    queryFn: async () => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Pest Management</span>
            </nav>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Pest Management</h1>
            <p className="text-xl mb-6 max-w-2xl mx-auto">
              Natural and organic pest control methods. Protect your plants using environmentally friendly solutions.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search pest management e-books..."
                  value={searchTerm}
        ...
        {ebooksLoading ? (
          ...
          <>
            <div className="mb-4">
              <p className="text-gray-600">
                Found {ebooks.length} e-book{ebooks.length !== 1 ? 's' : ''} in Pest Management
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {ebooks.map((ebook) => (
          ...
          <div className="text-center py-12">
            <div className="text-gray-400 mb-4">
              <Bug className="h-16 w-16 mx-auto" />
            </div>
