...
import { Search, Star, Download, Globe, Award, Home, ArrowLeft, Recycle } from "lucide-react";
...
export default function PermaculturePage() {
  ...
  const { data: ebooks = [], isLoading: ebooksLoading } = useQuery({
    queryKey: ['/api/ebooks', searchTerm, 'permaculture', sortBy, priceFilter],
    queryFn: async () => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Permaculture</span>
            </nav>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Permaculture</h1>
            <p className="text-xl mb-6 max-w-2xl mx-auto">
              Sustainable ecosystem design and permaculture. Create self-sustaining agricultural systems and regenerative landscapes.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search permaculture e-books..."
                  value={searchTerm}
          ...
          <>
            <div className="mb-4">
              <p className="text-gray-600">
                Found {ebooks.length} e-book{ebooks.length !== 1 ? 's' : ''} in Permaculture
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {ebooks.map((ebook) => (
