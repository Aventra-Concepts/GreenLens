...
import { Search, Star, Download, Globe, Award, Home, ArrowLeft, Wrench } from "lucide-react";
...
export default function GardenToolsPage() {
  ...
  const { data: ebooks = [], isLoading: ebooksLoading } = useQuery({
    queryKey: ['/api/ebooks', searchTerm, 'garden-tools', sortBy, priceFilter],
    queryFn: async () => {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Garden Tools</span>
            </nav>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl mb-6 max-w-2xl mx-auto">
              Guide to gardening tools and equipment. Choose the right tools to make your gardening more efficient.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search garden tools e-books..."
                  value={searchTerm}
          ...
          <>
            <div className="mb-4">
              <p className="text-gray-600">
                Found {ebooks.length} e-book{ebooks.length !== 1 ? 's' : ''} in Garden Tools
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {ebooks.map((ebook) => (
