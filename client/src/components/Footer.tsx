        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold">GreenLens</span>
            </div>
          ...
          <div>
            <h3 className="font-semibold text-base mb-3">E-books & Shop</h3>
            <ul className="space-y-1 text-gray-400 text-sm">
              <li>
          ...
          <div>
            <h3 className="font-semibold text-base mb-3">Registration</h3>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <Link 
                  href="/student-registration" 
                  className="text-blue-400 hover:text-blue-300 font-bold transition-colors border-b border-blue-400 hover:border-blue-300 block text-sm"
              ...
              <li>
                <Link 
                  ...
                  className="text-yellow-400 hover:text-yellow-300 font-bold transition-colors border-b border-yellow-400 hover:border-yellow-300 block text-sm"
