...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-32 z-[9999] max-w-[280px] animate-in slide-in-from-left-5 duration-500" style={{ zIndex: 9999, animation: 'gentle-pulse 2s ease-in-out infinite' }}>
