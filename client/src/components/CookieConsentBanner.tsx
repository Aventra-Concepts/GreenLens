...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 md:left-32 md:transform-none md:translate-x-0 z-[9999] max-w-[280px] animate-in slide-in-from-bottom-5 md:slide-in-from-left-5 duration-500" style={{ zIndex: 9999, animation: 'gentle-pulse 2s ease-in-out infinite' }}>
