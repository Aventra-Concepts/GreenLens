...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[9999] max-w-[24px] animate-in slide-in-from-bottom-5 duration-500 px-4" style={{ zIndex: 9999, animation: 'gentle-pulse 2s ease-in-out infinite' }}>
